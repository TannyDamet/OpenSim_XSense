...
donnees_IMU1 = readmatrix('IMU1_data.csv'); % Assurez-vous que le format du fichier est correct
donnees_IMU2 = readmatrix('IMU2_data.csv'); % Assurez-vous que le format du fichier est correct
...
% Paramètres du filtre de Kalman unscented
...
% Filtrage des données des IMUs avec le filtre de Kalman unscented
kf = unscentedKalmanFilter(@transitionFcn, @measurementFcn, x_initial, P_initial, 'HasAdditiveMeasurementNoise', true);
kf.ProcessNoise = Q;
...
% Fonction de transition pour le filtre de Kalman unscented
...
% Fonction de mesure pour le filtre de Kalman unscented
