...
writecell(data1_modified, "Tanny_Calib + A1\Xsens_1_modified.csv");
writecell(data2_modified, "Tanny_Calib + A1\Xsens_2_modified.csv");
writecell(data3_modified, "Tanny_Calib + A1\Xsens_3_modified.csv");
writecell(data4_modified, "Tanny_Calib + A1\Xsens_4_modified.csv");
writecell(data5_modified, "Tanny_Calib + A1\Xsens_5_modified.csv");
