...
orientationsFileNames = {'DATA\pos_rot_1\Xsens_1.sto','DATA\pos_rot_1\Xsens_2.sto','DATA\pos_rot_1\Xsens_3.sto','DATA\pos_rot_1\Xsens_4.sto','DATA\pos_rot_1\Xsens_5.sto'};   % The paths to orientation data for calibration 
...
model.print( strrep(modelFileName, '.osim', '_calibrated0.osim') );