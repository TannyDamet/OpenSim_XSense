...
wRi1w = wRi1*inv(i1wRi1); % Repère imu 1 lu dans le repère monde
wRi2w = wRi1*inv(i2wRi2); % Repère imu 2 lu dans le repère monde
wRi3w = wRi1*inv(i3wRi3); % Repère imu 3 lu dans le repère monde
wRi4w = wRi1*inv(i4wRi4); % Repère imu 4 lu dans le repère monde
wRi5w = wRi1*inv(i5wRi5); % Repère imu 5 lu dans le repère monde
