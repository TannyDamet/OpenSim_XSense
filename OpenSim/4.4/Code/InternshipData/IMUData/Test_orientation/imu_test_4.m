...
% data1 = open("DATA\pos_rot_1\11\Xsens_1.csv");
% data2 = open("DATA\pos_rot_1\11\Xsens_2.csv");
% data3 = open("DATA\pos_rot_1\11\Xsens_3.csv");
% data4 = open("DATA\pos_rot_1\11\Xsens_4.csv");
% data5 = open("DATA\pos_rot_1\11\Xsens_5.csv");

data1 = open("DATA\Mouv_1\Xsens_1.csv");
data2 = open("DATA\Mouv_1\Xsens_2.csv");
data3 = open("DATA\Mouv_1\Xsens_3.csv");
data4 = open("DATA\Mouv_1\Xsens_4.csv");
data5 = open("DATA\Mouv_1\Xsens_5.csv");
...
% writecell(data1_modified, "DATA\pos_rot_1\11\Xsens_1_modified.csv");
% writecell(data2_modified, "DATA\pos_rot_1\11\Xsens_2_modified.csv");
% writecell(data3_modified, "DATA\pos_rot_1\11\Xsens_3_modified.csv");
% writecell(data4_modified, "DATA\pos_rot_1\11\Xsens_4_modified.csv");
% writecell(data5_modified, "DATA\pos_rot_1\11\Xsens_5_modified.csv");

writecell(data1_modified, "DATA\Mouv_1\Xsens_1_modified.csv");
writecell(data2_modified, "DATA\Mouv_1\Xsens_2_modified.csv");
writecell(data3_modified, "DATA\Mouv_1\Xsens_3_modified.csv");
writecell(data4_modified, "DATA\Mouv_1\Xsens_4_modified.csv");
writecell(data5_modified, "DATA\Mouv_1\Xsens_5_modified.csv");
