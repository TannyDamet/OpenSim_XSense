...
% data1 = open("Claire_Calib + A1\Xsens_1_20201125_111832_881.csv");
% data2 = open("Claire_Calib + A1\Xsens_2_20201125_111832_882.csv");
% data3 = open("Claire_Calib + A1\Xsens_3_20201125_111832_879.csv");
% data4 = open("Claire_Calib + A1\Xsens_4_20201125_111832_880.csv");
% data5 = open("Claire_Calib + A1\Xsens_5_20201125_111832_882.csv");

data1 = open("Claire_Calib + A1\Xsens_1.csv");
data2 = open("Claire_Calib + A1\Xsens_2.csv");
data3 = open("Claire_Calib + A1\Xsens_3.csv");
data4 = open("Claire_Calib + A1\Xsens_4.csv");
data5 = open("Claire_Calib + A1\Xsens_5.csv");
...
writecell(data1_modified, "Claire_Calib + A1\Xsens_1_modified.csv");
writecell(data2_modified, "Claire_Calib + A1\Xsens_2_modified.csv");
writecell(data3_modified, "Claire_Calib + A1\Xsens_3_modified.csv");
writecell(data4_modified, "Claire_Calib + A1\Xsens_4_modified.csv");
writecell(data5_modified, "Claire_Calib + A1\Xsens_5_modified.csv");
