...
% data1 = open("Tanny_Calib + A1\Xsens_1_20201125_110217_795.csv");
% data2 = open("Tanny_Calib + A1\Xsens_2_20201125_110217_796.csv");
% data3 = open("Tanny_Calib + A1\Xsens_3_20201125_110217_793.csv");
% data4 = open("Tanny_Calib + A1\Xsens_4_20201125_110217_794.csv");
% data5 = open("Tanny_Calib + A1\Xsens_5_20201125_110217_797.csv");

data1 = open("Tanny_Calib + A1\Xsens_1.csv");
data2 = open("Tanny_Calib + A1\Xsens_2.csv");
data3 = open("Tanny_Calib + A1\Xsens_3.csv");
data4 = open("Tanny_Calib + A1\Xsens_4.csv");
data5 = open("Tanny_Calib + A1\Xsens_5.csv");
...
wRi0_1 = [0 1 0; 0 0 1; 1 0 0];
wRi0_2 = [0 0 -1; -1 0 0; 0 1 0];
wRi0_3 = [0 0 -1; -1 0 0; 0 1 0];
wRi0_4 = [0 0 1; 1 0 0; 0 1 0];
wRi0_5 = [0 0 1; 1 0 0; 0 1 0];
...
writecell(data1_modified, "Tanny_Calib + A1\Xsens_1_modified2.csv");
writecell(data2_modified, "Tanny_Calib + A1\Xsens_2_modified2.csv");
writecell(data3_modified, "Tanny_Calib + A1\Xsens_3_modified2.csv");
writecell(data4_modified, "Tanny_Calib + A1\Xsens_4_modified2.csv");
writecell(data5_modified, "Tanny_Calib + A1\Xsens_5_modified2.csv");
