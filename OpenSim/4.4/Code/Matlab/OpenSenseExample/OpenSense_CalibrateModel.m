...
orientationsFileName = 'Xsens.sto';   % The path to orientation data for calibration 
sensor_to_opensim_rotations = Vec3(-pi/2, 0, -pi/2);% The rotation of IMU data to the OpenSim world frame 
